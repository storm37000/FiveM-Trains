Citizen.CreateThread(function()
	...
	function StartTrain()
		...
		DeleteAllTrains()
		local Train = CreateMissionTrain(math.random(0,22), x,y,z,yesorno)
		local MetroTrain = CreateMissionTrain(24,40.2,-1201.3,31.0,true) -- these ones have pre-defined spawns since they are a pain to set up
		local MetroTrain2 = CreateMissionTrain(24,-618.0,-1476.8,16.2,true)
